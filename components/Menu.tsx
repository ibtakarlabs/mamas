    ...
    <section id="menu" className="py-10 bg-warm-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-charcoal/70 uppercase tracking-wide">Everything made fresh, nothing frozen</p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-8">
          {Object.keys(menuCategories).map((category) => (
            <button
              ...
              className={`px-6 py-2.5 font-heading font-bold text-lg uppercase tracking-wide border-3 transition-all ${
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-diner-white border-4 border-charcoal p-6 shadow-xl">
            <h3 className="font-heading text-4xl md:text-5xl font-bold text-charcoal mb-3 pb-3 border-b-3 border-charcoal uppercase tracking-tight">
            ...
            <div className="space-y-3">
              {menuCategories[activeCategory as keyof typeof menuCategories].map((item, index) => (
                ...
                >
                  <span className="font-body text-charcoal font-semibold flex-1 text-lg">{item.name}</span>
                  <span className="font-heading text-tomato-red font-bold text-2xl ml-4 tracking-wide">
                    {item.price}
                  </span>
                </div>
              ))}
          ...
          <div className="mt-6 bg-charcoal text-diner-white py-3 px-4 text-center border-3 border-charcoal">
            <p className="text-base uppercase tracking-wider mb-1">All wraps served with housemade chips</p>
